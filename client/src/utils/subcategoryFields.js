...
export const SUBCATEGORY_FIELDS = {
  'Real Estate': {
    ...
    'Land': {
      fields: ['landArea', 'type', 'amenities'],
...
export const FIELD_METADATA = {
  ...
  // Vehicle fields
  brand: { label: 'Brand', type: 'text', placeholder: 'e.g., Toyota' },
  model: { label: 'Model', type: 'text', placeholder: 'e.g., Corolla' },
  ...
  accessories: { label: 'Accessories Included (comma-separated)', type: 'text', placeholder: 'e.g., Charger, Headphones' },
  electronicFeatures: { label: 'Features (comma-separated)', type: 'text', placeholder: 'e.g., Face ID, Fingerprint, Fast charging' }
};
