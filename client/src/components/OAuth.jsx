...
export default function OAuth() {
  ...
  return (
    handleGoogleClick //<button onClick={handleGoogleClick} type='button' className="bg-red-500 text-white p-3 rounded-lg uppercase hover:opacity-95">Continue with google</button>
  )
}
