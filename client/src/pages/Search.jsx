      ...
      <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <input type="text" placeholder="Search..." className="border w-full p-3 rounded-lg" id="searchTerm" onChange={handleChange} value={sidebarData.searchTerm} />
          </div>
          ...
          <div className='flex items-center gap-2'>
           ...
           <button className='text-white border bg-slate-700 p-3 rounded-lg uppercase hover:shadow-lg disabled:opacity-80 mt-4'>Search</button>                  
      ...
      <div className='flex-1'>
        ...
        <div className='p-7 flex flex-wrap gap-4'>
          ...
          {!loading && listings && listings.map((listing) => <ListingItem key={listing._id} listing={listing}/>
           ...
           {showMore && (
              <button  onClick={onShowMoreClick} className='text-green-700 p-7  hover:underline '>Show More</button>
            )}
